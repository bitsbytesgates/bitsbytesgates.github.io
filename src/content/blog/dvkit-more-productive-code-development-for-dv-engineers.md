---
title: 'DVKit: More-productive Code Development for DV Engineers'
...
[![](/legacy-img/BlogHeadline.png)](/legacy-img/BlogHeadline.png)

</div>

  
  
<span id="docs-internal-guid-71002205-8557-d197-2d28-a99c02b50792"></span>If you're a design verification (DV) engineer, how many different languages do you code in every day? If you're like me, the number is significant. On any given day, I might find myself working on SystemVerilog, PERL, shell script, Makefile, even C++. Text editors like [Vim](http://www.vim.org/) and a host of others can edit any text file, and even provide some basic syntax coloring.  
...
There are a number of IDEs available, but many tend to focus on a handful of languages. [Visual Studio](https://www.visualstudio.com/), for example, focuses on C, C++, and C#. [NetBeans](http://netbeans.org/) focuses on Java and web languages. With the large variety of languages used for design verification, we need an IDE with support for the same large variety of languages.
...
If you're looking for a true integrated development environment (IDE) for multiple languages, the [Eclipse](https://www.eclipse.org/home/index.php) platform is a natural choice. Originally developed by IBM as an integrated development environment for Smalltalk and Java, Eclipse has evolved into an open source platform that supports development of a dizzying array of languages -- from Java to C++ to ANTLR and beyond. As an integrated development environment, Eclipse not only provides text editing and syntax highlighting, it provides support for easily navigating code structure. For example, navigating from where a field is used to where it was declared.  
...
You can find DVKit at [http://dvkit.org](http://dvkit.org/), and the downloads page [here](https://sourceforge.net/projects/dvkit/files/).  
